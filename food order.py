...
import cgi 
db=mysql.connector.connect(host="localhost",user="root",password="",db="food order")
cur=db.cursor()
...
<section class="navbar navbar-default navbar-fixed-top" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand"><span>F</span>oo<span>D</span><span>S</span>torag<span>e</span></a>
		</div>
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#home" class="smoothScroll">HOME</a></li>
				<li><a href="foodgalary.py" class="smoothScroll">FOOD GALLERY</a></li>
				<li><a href="login.html" class="smoothScroll">USER</a></li>
